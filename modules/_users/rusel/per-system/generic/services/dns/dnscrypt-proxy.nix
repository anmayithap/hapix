    ...
    services.dnscrypt-proxy = {
      ...
      settings = {
        ...
        */
        ...
        sources = {
          public-resolvers = {
            ...
            minisign_key = lib.mkDefault "RWQf6LRCGA9i53mlYecO4IsT51TGPpvWucNSCh1CBM0QTaLn73Y7GFO3"; # typos: ignore
        ...
        */
        static = {
          # geohide = {
          # stamp = "sdns://AgcAAAAAAAAAEmRucy5nZW9oaWRlLnJ1OjQ0NAAACi9kbnMtcXVlcnk";
          # };
          astracat = {
